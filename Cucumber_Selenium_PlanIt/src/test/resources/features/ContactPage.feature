...
When User populates field "Forename" as "Monika"
And User populates field "Email" as "solankimonika31@gmail.com"
And User populates field "Message" as "Hi this is a sample message"
...
Given User navigates to Contact page from Home page
When User populates field "Forename" as "Monika"
And User populates field "Email" as "solankimonika31"
And User populates field "Message" as "Hi this is a sample message"
#When User populates mandatory fields
#| Forename | Email            | Message                     | 
