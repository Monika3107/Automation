...
@CucumberOptions(
		features = "src//test//resources//features//ContactPage.feature", //Path of feature file
		...
		//,tags = {"@homeTag, @loginTag"}
		//tags = {"@aselfAssessGenericAttributes, @bselfAssessProfessionalSkills, @cselfAssessSoftSkills"}
		//,tags = "~@skip"
		)
